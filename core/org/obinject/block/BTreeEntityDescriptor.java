...
/**
 * <p>This class implements a B+ Tree descriptor Node.</p> 
 * 
 * <blockquote><pre>
 * {@code
 * Design:
 *
 * +-------------------+------+----------------+
 * |node|par-|prev|next| root |                |
 * |type|-ent|page|page| page |                |
 * |    |node| Id | Id |  Id  |<--free space-->|
 * |    |    |    |    |      |                |
 * |-------------------+------|                |
 * |      header       |featur|                |
 * +-------------------+------+----------------+
 ...
 */
public class BTreeEntityDescriptor extends DescriptorNode
{

    /**
     *
     */
    public static final int nodeType = 1007;

    /**
     *
     * @param node
     */
    public BTreeEntityDescriptor(Node node)
    {
	super(node);
        initialize(node);
    }
