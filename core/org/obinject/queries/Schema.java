 ...
 * @param <T>
 */
public interface Schema <E extends Entity, K extends Key, T>
{    
    /**
     *
     * @param value
     ...
     * @return
     */
    public K newKey(T value);    

    /**
     *
     * @return
     */
    public EntityStructure<? extends Entity> getEntityStructure();

    /**
     *
     * @return
     */
    public KeyStructure<? extends Key> getKeyStructure();
