 ...
 * @param <M>
 */
public abstract class ChanneledJoinMTreeFirstQualification<M extends Metric<M> & Entity<? super M>> extends AbstractStrategy<M> {
    ...
    public ChanneledJoinMTreeFirstQualification(MTree<M> mtree, List<M> routeOfPoint, double range) {
        super(mtree);
                ...
                for (int j = 0; j < total; j++) {
                    ...
                    for (int i = 0; i < routeOfPoint.size() - 1; i++) {
                        ...
                        if ((Math.pow(c, 2) >= Math.pow(b, 2) + Math.pow(a, 2))) {
                            ...
                            if ((b <= cov + range)) {
                                if (!qualifies.add(new Qualify(index.readSubPageId(j), b))) {
                            ...
                            if (c <= cov + range) {
                                if (!qualifies.add(new Qualify(index.readSubPageId(j), c))) {
                                    System.out.println("@@@@@ falhou na insercao da qualificacao do range");
                                }
                                break;
                            }
                            ...
                            if (taltura <= cov + range) {
                                if (!qualifies.add(new Qualify(index.readSubPageId(j), taltura))) {
                                    System.out.println("@@@@@ falhou na insercao da qualificacao do range");
                                }
                                break;
                            }
