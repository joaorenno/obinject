...
public interface Entity<E extends Entity<E>>{        
    ...
    /**
     * This method is used to inject entity into persistence 
     * structure and into indexing structure.
     *
     * @return true if the entity was injected. 
     */
    public boolean inject();
    
    /**
     * This method is used to purge entity into persistence 
     * structure and into indexing structure.
     *
     * @return true if the entity was purged. 
     */
    public boolean reject();
    
    /**
     * This method is used to modify entity into persistence 
     * structure and into indexing structure.
     *
    ...
    /**
     * Returns the structure used to store the persistent entity.
     * 
     * @return the structure.
     */
    public EntityStructure<E> getEntityStructure();
}
