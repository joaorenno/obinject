 ...
 */
public class ProteinKeyGenerator extends CodeGenerator<ProteinKeyDefinition>
{
    /**
     *
     * @param definition
     */
    public ProteinKeyGenerator(ProteinKeyDefinition definition)
    {
        super(definition);
    }
...
//    }
	...
	code.append("public double distanceTo(").append(this.getDefinition().getClassName()).append(" obj){ ");
        code.append("return DistanceUtil.protein(this.getString(), obj.getString()); } ");
    }
