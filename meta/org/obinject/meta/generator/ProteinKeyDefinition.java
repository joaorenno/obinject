 ...
 * 
 */
public class ProteinKeyDefinition extends KeyDefinition<KeyField> {

    public static final String prefix = "Protein";
    
    public ProteinKeyDefinition(Class<?> userClazz, String prefixClassName, 
