 ...
 * 
 */
public class UniqueKeyDefinition extends KeyDefinition<KeyField> {

    public static final String prefix = "Unique";

    public UniqueKeyDefinition(Class<?> userClazz, String prefixClassName, 
