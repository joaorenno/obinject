 ...
 */
public class CoordinateKeyGenerator extends CodeGenerator<CoordinateKeyDefinition> {
     ...
     * @param definition
     */
    public CoordinateKeyGenerator(CoordinateKeyDefinition definition) {
        super(definition);
        Object newObj;
        Object returnMethod;
        char typeReturn;
...
//    }
    ...
    private void generateGetOrigin() {
        Object newObj;
        int dim = 0;
        int sizeVector = 0;
        Object returnMethod;
    ...
    private void generateDistanceTo() {
        ...
        CoordinateKeyField field = this.getDefinition().getKeyFields().iterator().next();
        switch (field.getAngleUnit()) {
            case Degree:
                code.append("return DistanceUtil.sphericalDistanceDegree(this, obj, ");
                break;
            case Radian:
                code.append("return DistanceUtil.sphericalDistanceRadian(this, obj, ");
                break;
        }
        code.append(field.getRadius()).append("); } ");
    }
