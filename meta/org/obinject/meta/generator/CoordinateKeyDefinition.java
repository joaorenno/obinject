 ...
 * 
 */
public class CoordinateKeyDefinition extends KeyDefinition<CoordinateKeyField> {

    public static final String prefix = "Coordinate";

    public CoordinateKeyDefinition(Class<?> userClazz, String prefixClassName, 
